...
/**
 * <p>SB_WF_InquiryReadSrvRequest complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="SB_WF_InquiryReadSrvRequest">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="MsgHeader" type="{http://csb.fmc.vispractice.com/MsgHeader}MsgHeader"/>
 *         &lt;element name="WF_READ_USER_NO" type="{http://www.w3.org/2001/XMLSchema}string"/>
...
@XmlType(name = "SB_WF_InquiryReadSrvRequest", propOrder = {
    "msgHeader",
    "wfreaduserno",
    "wfapplycode",
    "wfapplyuserno",
...
public class SBWFInquiryReadSrvRequest {

    @XmlElement(name = "MsgHeader", required = true)
    protected MsgHeader msgHeader;
    @XmlElement(name = "WF_READ_USER_NO", required = true, nillable = true)
    protected String wfreaduserno;
     ...
     *     
     */
    public void setWFREADUSERNO(String value) {
        this.wfreaduserno = value;
    }
