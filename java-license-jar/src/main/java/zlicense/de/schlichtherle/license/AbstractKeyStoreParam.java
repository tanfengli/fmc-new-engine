...
public abstract class AbstractKeyStoreParam implements KeyStoreParam {
	...
	public InputStream getStream() throws IOException {
		...
		// InputStream localInputStream = new FileInputStream("C:\\license\\publicCerts.store");//zjs
	...
	public boolean equals(Object paramObject) {
		...
		return (this.clazz.getResource(this.resource)
				.equals(localAbstractKeyStoreParam.clazz
						.getResource(localAbstractKeyStoreParam.resource)))
